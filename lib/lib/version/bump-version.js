...
class BumpVersion extends version_base_1.default {
    /**
     ...
     */
    constructor(releaseType, skipCommit = false) {
        super(releaseType);
...
__decorate([
    (0, decorators_1.logGroup)('Bump version')
], BumpVersion.prototype, "run", null);
